...
\title{\vspace{-15mm}\fontsize{18pt}{10pt}\selectfont\textbf{A comparison of classifiers for oil spill detection}} % Article title
...
\section{Oil spill detection methods}
	...
	\input{./sections/2.oil-spill-methods.tex}
...
\section{Features}
	...
	\input{./sections/4.oil-spill-features.tex}
...
\subsection{What is supervised learning}
	...
	\input{./sections/5.supervised-learning.tex}

\subsection{Support Vector Machines}

	\input{./sections/6.SVM-summary.tex}

\subsection{Decision Trees}

	\input{./sections/7.DT-summary.tex}

\subsection{Multi Layer Perceptrons}

	\input{./sections/8.MLP-summary.tex}

%------------------------------------------------

\section{Comparison of classifiers}

\input{./sections/9.0.Introduction.tex}

\subsection{SVM Vs DT}

	\input{./sections/9.SVM-vs-DT.tex}
	
\subsection{SVM Vs MLP}
	
	\input{./sections/10.SVM-vs-MLP.tex}
	
\subsection{DT Vs MLP}

	\input{./sections/11.DT-vs-MLP.tex}

%------------------------------------------------

\section{Discussion}

	\input{./sections/12.discussion.tex}
