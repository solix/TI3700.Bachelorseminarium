...
%Reply Thomas: But this first sentence doesnt say that.
...
%Reply Thomas: Matter of opinion, but we will stick with your plan
If a comparison is done theoretically then SVM and MLP have their own distinguishing advantages. 
%This piece was copy pasted from SVM summary and was also a bit unclear there.
%Reply Soheil: Removed from this section, I personally I don't think is unclear, Also jesse didn't commented anything on this, I suggest to keep it. 
%Reply Thomas: I still think strong foundational theory is a irrelevant and vague term, but ok.
...
%Reply Thomas: But do we use the stochastic property anywhere in oil spill detection? If so, please cite that in the future.
...
%Reply Thomas: I understand the reasoning but we need hard evidence and citations to make such a statement. 
...
%Reply Thomas: I understand that, but saying "SVM can be as good as MLP" suggests that MLP is usually better, of which we have no evidence.
...
%Reply Thomas: I actually read liu2006boosting and it says nothing about why you should choose MLP over SVM. If you have a citation please add it, otherwise it is an empty statement.
